...
public class UserAgentUtil {
	 ...
	 * @return
	 */
	private static UserAgentInfo judgeBrowser(String userAgent, String platformType, String platformSeries, String platformVersion) {
		if (userAgent.contains("Chrome")) {
			...
			return new UserAgentInfo("Chrome", chromeVersion, platformType, platformSeries, platformVersion);
			...
			return new UserAgentInfo("Firefox", ffVersion, platformType, platformSeries, platformVersion);
			...
			if (userAgent.contains("MSIE 10.0")) {//Internet Explorer 10
				return new UserAgentInfo("Internet Explorer", "10", platformType, platformSeries, platformVersion);
			} else if (userAgent.contains("MSIE 9.0")) {//Internet Explorer 9
				return new UserAgentInfo("Internet Explorer", "9", platformType, platformSeries, platformVersion);
			} else if (userAgent.contains("MSIE 8.0")) {//Internet Explorer 8
				return new UserAgentInfo("Internet Explorer", "8", platformType, platformSeries, platformVersion);
			} else if (userAgent.contains("MSIE 7.0")) {//Internet Explorer 7
				return new UserAgentInfo("Internet Explorer", "7", platformType, platformSeries, platformVersion);
			} else if (userAgent.contains("MSIE 6.0")) {//Internet Explorer 6
				return new UserAgentInfo("Internet Explorer", "6", platformType, platformSeries, platformVersion);
			}
		} else {//暂时支持以上三个主流.其它浏览器,待续...
			return new UserAgentInfo(null, null, platformType, platformSeries, platformVersion);
		}
		return null;
	}
}